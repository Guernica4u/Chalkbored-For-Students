...
SYSTEMS = {
    "nes": {
        "folders": ["ROMS/NES", "NES", "nes", "roms/nes"],
        "exts": [".nes", ".unf", ".unif"],
    },
    "snes": {
        "folders": ["ROMS/SNES", "SNES", "snes", "roms/snes"],
...
OUT = os.path.join("SCRIPTS", "roms.json")
...
def main():
    ...
    print("\nWrote %s (%d game(s) total)." % (web(OUT), total))
    if not total:
